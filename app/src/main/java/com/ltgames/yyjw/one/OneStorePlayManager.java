...
public class OneStorePlayManager {
     ...
     * @param mListener 回调
     */
    public static void initOneStore(final Activity context, String publickey, final String LTAppID, final String LTAppKey,
        ...
        if (mPurchaseClient == null) {
            ...
            mPurchaseClient.isBillingSupportedAsync(IAP_API_VERSION, new PurchaseClient.BillingSupportedListener() {
                ...
                public void onSuccess() {
                    ...
                    loadPurchases((Activity) context,  mListener, mUploadListener);
                }
     ...
     * 查看历史记录
     */
    private static void loadPurchases(Activity context,
                                      onOneStoreSupportListener mListener,
                                      onOneStoreUploadListener mUploadListener) {
        loadPurchase(context,IapEnum.ProductType.ALL, mListener, mUploadListener);
     ...
     */
    private static void loadPurchase(final Activity context,
                                     final IapEnum.ProductType productType,
     ...
     */
    private static void onLoadPurchaseInApp(List<PurchaseData> purchaseDataList, onOneStoreSupportListener mListener) {
     ...
     * @param purchaseDataList 购买数据
     */
    private static void onLoadPurchaseAuto(List<PurchaseData> purchaseDataList) {
     ...
     */
    public static void getProduct(final Activity context, final String LTAppID, final String LTAppKey, int selfRequestCode, String productName,
                                  final String productId,final onOneStoreUploadListener mUpLoadListener,
                                  final onOneStoreSupportListener mListener) {
        if (!mIsInit) {
